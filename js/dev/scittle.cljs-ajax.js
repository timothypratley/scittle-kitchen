...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_46127 = function($this$$$, $request$$, $handler$$) {
...
ajax.protocols._js_ajax_request = function($this$$$, $request$$, $handler$$) {
  return $this$$$ != null && $this$$$.ajax$protocols$AjaxImpl$_js_ajax_request$arity$3 != null ? $this$$$.ajax$protocols$AjaxImpl$_js_ajax_request$arity$3($this$$$, $request$$, $handler$$) : ajax$protocols$AjaxImpl$_js_ajax_request$dyn_46127($this$$$, $request$$, $handler$$);
};
ajax.protocols.AjaxRequest = function() {
};
var ajax$protocols$AjaxRequest$_abort$dyn_46136 = function($this$$$) {
...
ajax.protocols._abort = function($this$$$) {
  return $this$$$ != null && $this$$$.ajax$protocols$AjaxRequest$_abort$arity$1 != null ? $this$$$.ajax$protocols$AjaxRequest$_abort$arity$1($this$$$) : ajax$protocols$AjaxRequest$_abort$dyn_46136($this$$$);
};
ajax.protocols.AjaxResponse = function() {
};
var ajax$protocols$AjaxResponse$_status$dyn_46137 = function($this$$$) {
...
ajax.protocols._status = function($this$$$) {
  return $this$$$ != null && $this$$$.ajax$protocols$AjaxResponse$_status$arity$1 != null ? $this$$$.ajax$protocols$AjaxResponse$_status$arity$1($this$$$) : ajax$protocols$AjaxResponse$_status$dyn_46137($this$$$);
};
var ajax$protocols$AjaxResponse$_status_text$dyn_46138 = function($this$$$) {
...
ajax.protocols._status_text = function($this$$$) {
  return $this$$$ != null && $this$$$.ajax$protocols$AjaxResponse$_status_text$arity$1 != null ? $this$$$.ajax$protocols$AjaxResponse$_status_text$arity$1($this$$$) : ajax$protocols$AjaxResponse$_status_text$dyn_46138($this$$$);
};
var ajax$protocols$AjaxResponse$_get_all_headers$dyn_46139 = function($this$$$) {
...
ajax.protocols._get_all_headers = function($this$$$) {
  return $this$$$ != null && $this$$$.ajax$protocols$AjaxResponse$_get_all_headers$arity$1 != null ? $this$$$.ajax$protocols$AjaxResponse$_get_all_headers$arity$1($this$$$) : ajax$protocols$AjaxResponse$_get_all_headers$dyn_46139($this$$$);
};
var ajax$protocols$AjaxResponse$_body$dyn_46140 = function($this$$$) {
...
ajax.protocols._body = function($this$$$) {
  return $this$$$ != null && $this$$$.ajax$protocols$AjaxResponse$_body$arity$1 != null ? $this$$$.ajax$protocols$AjaxResponse$_body$arity$1($this$$$) : ajax$protocols$AjaxResponse$_body$dyn_46140($this$$$);
};
...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = function($this__5325__auto__$$, $k46069$$, $else__5326__auto__$$) {
  switch($k46069$$ instanceof $APP.cljs.core.Keyword ? $k46069$$.fqn : null) {
    case "status":
      return this.status;
    case "body":
      return this.body;
    ...
    default:
      return $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$3(this.__extmap, $k46069$$, $else__5326__auto__$$);
  }
};
ajax.protocols.Response.prototype.cljs$core$IKVReduce$_kv_reduce$arity$3 = function($this__5343__auto__$$, $f__5344__auto__$$, $init__5345__auto__$$) {
  return $APP.cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(function($ret__5346__auto__$$, $p__46076_v__5348__auto__$$) {
    var $k__5347__auto__$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($p__46076_v__5348__auto__$$, 0, null);
    $p__46076_v__5348__auto__$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($p__46076_v__5348__auto__$$, 1, null);
    return $f__5344__auto__$$.cljs$core$IFn$_invoke$arity$3 ? $f__5344__auto__$$.cljs$core$IFn$_invoke$arity$3($ret__5346__auto__$$, $k__5347__auto__$$, $p__46076_v__5348__auto__$$) : $f__5344__auto__$$.call(null, $ret__5346__auto__$$, $k__5347__auto__$$, $p__46076_v__5348__auto__$$);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = function($G__46068$$) {
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = function($this46070$$, $other46071$$) {
  return $other46071$$ != null && this.constructor === $other46071$$.constructor && $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this.status, $other46071$$.status) && $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this.body, $other46071$$.body) && $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this.status_text, $other46071$$.status_text) && $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this.headers, $other46071$$.headers) && $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this.was_aborted, 
  $other46071$$.was_aborted) && $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this.__extmap, $other46071$$.__extmap);
};
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = function($this__5330__auto__$$, $k46069$$) {
  switch($k46069$$ instanceof $APP.cljs.core.Keyword ? $k46069$$.fqn : null) {
    case "status":
    case "body":
    case "status-text":
    ...
    case "was-aborted":
      return !0;
    default:
      return $APP.cljs.core.contains_QMARK_(this.__extmap, $k46069$$);
  }
};
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = function($pred__46087_this__5331__auto__$$, $k__5332__auto__$$, $G__46068$$) {
  $pred__46087_this__5331__auto__$$ = $APP.cljs.core.keyword_identical_QMARK_;
  return $APP.cljs.core.truth_($pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2 ? $pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2($APP.cljs$cst$109$status, $k__5332__auto__$$) : $pred__46087_this__5331__auto__$$.call(null, $APP.cljs$cst$109$status, $k__5332__auto__$$)) ? new ajax.protocols.Response($G__46068$$, this.body, this.status_text, this.headers, this.was_aborted, this.__meta, this.__extmap, null) : $APP.cljs.core.truth_($pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2 ? 
  $pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2($APP.cljs$cst$411$body, $k__5332__auto__$$) : $pred__46087_this__5331__auto__$$.call(null, $APP.cljs$cst$411$body, $k__5332__auto__$$)) ? new ajax.protocols.Response(this.status, $G__46068$$, this.status_text, this.headers, this.was_aborted, this.__meta, this.__extmap, null) : $APP.cljs.core.truth_($pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2 ? $pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2(cljs$cst$2605$status_text, 
  $k__5332__auto__$$) : $pred__46087_this__5331__auto__$$.call(null, cljs$cst$2605$status_text, $k__5332__auto__$$)) ? new ajax.protocols.Response(this.status, this.body, $G__46068$$, this.headers, this.was_aborted, this.__meta, this.__extmap, null) : $APP.cljs.core.truth_($pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2 ? $pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2($APP.cljs$cst$2606$headers, $k__5332__auto__$$) : $pred__46087_this__5331__auto__$$.call(null, $APP.cljs$cst$2606$headers, 
  $k__5332__auto__$$)) ? new ajax.protocols.Response(this.status, this.body, this.status_text, $G__46068$$, this.was_aborted, this.__meta, this.__extmap, null) : $APP.cljs.core.truth_($pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2 ? $pred__46087_this__5331__auto__$$.cljs$core$IFn$_invoke$arity$2(cljs$cst$2607$was_aborted, $k__5332__auto__$$) : $pred__46087_this__5331__auto__$$.call(null, cljs$cst$2607$was_aborted, $k__5332__auto__$$)) ? new ajax.protocols.Response(this.status, this.body, 
  this.status_text, this.headers, $G__46068$$, this.__meta, this.__extmap, null) : new ajax.protocols.Response(this.status, this.body, this.status_text, this.headers, this.was_aborted, this.__meta, $APP.cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(this.__extmap, $k__5332__auto__$$, $G__46068$$), null);
};
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function($this__5322__auto__$$, $G__46068$$) {
  return new ajax.protocols.Response(this.status, this.body, this.status_text, this.headers, this.was_aborted, $G__46068$$, this.__extmap, this.__hash);
};
...
ajax.protocols.map__GT_Response = function($G__46072$$) {
  var $G__46116$jscomp$inline_5048_extmap__5365__auto__$$ = $APP.cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic($G__46072$$, $APP.cljs$cst$109$status, $APP.cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([$APP.cljs$cst$411$body, cljs$cst$2605$status_text, $APP.cljs$cst$2606$headers, cljs$cst$2607$was_aborted], 0));
  $G__46116$jscomp$inline_5048_extmap__5365__auto__$$ = $APP.cljs.core.record_QMARK_($G__46072$$) ? $APP.cljs.core.into.cljs$core$IFn$_invoke$arity$2($APP.cljs.core.PersistentArrayMap.EMPTY, $G__46116$jscomp$inline_5048_extmap__5365__auto__$$) : $G__46116$jscomp$inline_5048_extmap__5365__auto__$$;
  return new ajax.protocols.Response($APP.cljs$cst$109$status.cljs$core$IFn$_invoke$arity$1($G__46072$$), $APP.cljs$cst$411$body.cljs$core$IFn$_invoke$arity$1($G__46072$$), cljs$cst$2605$status_text.cljs$core$IFn$_invoke$arity$1($G__46072$$), $APP.cljs$cst$2606$headers.cljs$core$IFn$_invoke$arity$1($G__46072$$), cljs$cst$2607$was_aborted.cljs$core$IFn$_invoke$arity$1($G__46072$$), null, $APP.cljs.core.not_empty($G__46116$jscomp$inline_5048_extmap__5365__auto__$$), null);
};
ajax.util = {};
...
ajax.interceptors.fail = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$209_argseq__5756__auto__$$ = [], $len__5749__auto___46301$$ = arguments.length, $i__5750__auto___46302$$ = 0;;) {
    if ($i__5750__auto___46302$$ < $len__5749__auto___46301$$) {
      $args__5755__auto__$jscomp$209_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46302$$]), $i__5750__auto___46302$$ += 1;
    } else {
      break;
    }
  }
...
ajax.json.make_json_response_format = function($read_json$$) {
  return function() {
    ...
    }, $ajax$json$make_json_response_format_$_json_response_format__1$$ = function($map__46310__$1_p__46309$$) {
      $map__46310__$1_p__46309$$ = $APP.cljs.core.__destructure_map($map__46310__$1_p__46309$$);
      var $prefix$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46310__$1_p__46309$$, $APP.cljs$cst$1543$prefix), $keywords_QMARK_$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46310__$1_p__46309$$, cljs$cst$2636$keywords_QMARK_), $raw$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46310__$1_p__46309$$, $APP.cljs$cst$1995$raw);
      return ajax.interceptors.map__GT_ResponseFormat(new $APP.cljs.core.PersistentArrayMap(null, 3, [cljs$cst$2624$read, function($G__46313_xhrio$$) {
        $G__46313_xhrio$$ = ajax.json.strip_prefix($prefix$$, ajax.protocols._body($G__46313_xhrio$$));
        return $read_json$$.cljs$core$IFn$_invoke$arity$3 ? $read_json$$.cljs$core$IFn$_invoke$arity$3($raw$$, $keywords_QMARK_$$, $G__46313_xhrio$$) : $read_json$$.call(null, $raw$$, $keywords_QMARK_$$, $G__46313_xhrio$$);
    ...
    $ajax$json$make_json_response_format_$_json_response_format$$ = function($p__46309$$) {
      switch(arguments.length) {
        case 0:
          return $ajax$json$make_json_response_format_$_json_response_format__0$$.call(this);
        case 1:
          return $ajax$json$make_json_response_format_$_json_response_format__1$$.call(this, $p__46309$$);
      }
...
ajax.transit = {};
ajax.transit.transit_type = function($map__46297__$1_or__5025__auto__$$) {
  $map__46297__$1_or__5025__auto__$$ = $APP.cljs.core.__destructure_map($map__46297__$1_or__5025__auto__$$);
  $map__46297__$1_or__5025__auto__$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46297__$1_or__5025__auto__$$, $APP.cljs$cst$139$type);
  return $APP.cljs.core.truth_($map__46297__$1_or__5025__auto__$$) ? $map__46297__$1_or__5025__auto__$$ : $APP.cljs$cst$2635$json;
};
...
ajax.formats.get_format = function($request$$, $G__46307_format_entry$$) {
  return $G__46307_format_entry$$ == null || $APP.cljs.core.map_QMARK_($G__46307_format_entry$$) ? $G__46307_format_entry$$ : $APP.cljs.core.vector_QMARK_($G__46307_format_entry$$) ? ($G__46307_format_entry$$ = $APP.cljs.core.second($G__46307_format_entry$$), ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2($request$$, $G__46307_format_entry$$) : ajax.formats.get_format.call(null, $request$$, $G__46307_format_entry$$)) : $G__46307_format_entry$$.cljs$core$IFn$_invoke$arity$1 ? 
  $G__46307_format_entry$$.cljs$core$IFn$_invoke$arity$1($request$$) : $G__46307_format_entry$$.call(null, $request$$);
};
...
ajax.formats.detect_content_type = function($content_type$$, $accept$jscomp$1_request$$, $format_entry$$) {
  ...
  return $APP.cljs.core.some(function($p1__46317_SHARP_$$) {
    return ajax.formats.content_type_matches($content_type$$, $p1__46317_SHARP_$$);
  }, $accept$jscomp$1_request$$);
};
ajax.formats.get_default_format = function($response$$, $p__46319_response_format$$) {
  var $map__46320__$1$$ = $APP.cljs.core.__destructure_map($p__46319_response_format$$);
  $p__46319_response_format$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46320__$1$$, cljs$cst$2634$response_format);
  var $content_type$$ = ajax.util.get_content_type($response$$);
  return ajax.formats.get_format($map__46320__$1$$, $APP.cljs.core.first($APP.cljs.core.filter.cljs$core$IFn$_invoke$arity$2(function($format_entry$$) {
    return ajax.formats.detect_content_type($content_type$$, $map__46320__$1$$, $format_entry$$);
  }, $p__46319_response_format$$)));
};
ajax.formats.detect_response_format_read = function($request$$) {
  return function($response$$) {
    var $fexpr__46321_format$$ = ajax.formats.get_default_format($response$$, $request$$);
    $fexpr__46321_format$$ = cljs$cst$2624$read.cljs$core$IFn$_invoke$arity$1($fexpr__46321_format$$);
    return $fexpr__46321_format$$.cljs$core$IFn$_invoke$arity$1 ? $fexpr__46321_format$$.cljs$core$IFn$_invoke$arity$1($response$$) : $fexpr__46321_format$$.call(null, $response$$);
  };
};
ajax.formats.accept_header = function($formats_p__46327_response_format$$) {
  var $map__46328__$1$$ = $APP.cljs.core.__destructure_map($formats_p__46327_response_format$$);
  $formats_p__46327_response_format$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46328__$1$$, cljs$cst$2634$response_format);
  $formats_p__46327_response_format$$ = $APP.cljs.core.vector_QMARK_($formats_p__46327_response_format$$) ? $formats_p__46327_response_format$$ : new $APP.cljs.core.PersistentVector(null, 1, 5, $APP.cljs.core.PersistentVector.EMPTY_NODE, [$formats_p__46327_response_format$$], null);
  return $APP.cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(function($p1__46322_SHARP_$$) {
    return ajax.formats.get_accept_entries($map__46328__$1$$, $p1__46322_SHARP_$$);
  }, $APP.cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([$formats_p__46327_response_format$$], 0));
};
...
ajax.ring.ring_response_format.cljs$core$IFn$_invoke$arity$1 = function($map__46334__$1_map__46335_p__46333_read$$) {
  $map__46334__$1_map__46335_p__46333_read$$ = $APP.cljs.core.__destructure_map($map__46334__$1_map__46335_p__46333_read$$);
  $map__46334__$1_map__46335_p__46333_read$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46334__$1_map__46335_p__46333_read$$, cljs$cst$2632$format);
  var $content_type$$ = $APP.cljs.core.__destructure_map($map__46334__$1_map__46335_p__46333_read$$);
  $map__46334__$1_map__46335_p__46333_read$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($content_type$$, cljs$cst$2624$read);
  var $description$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($content_type$$, cljs$cst$2620$description);
  $content_type$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($content_type$$, cljs$cst$2615$content_type);
  return ajax.interceptors.map__GT_ResponseFormat(new $APP.cljs.core.PersistentArrayMap(null, 3, [cljs$cst$2624$read, ajax.ring.make_ring_read($map__46334__$1_map__46335_p__46333_read$$), cljs$cst$2620$description, ["ring/", $APP.cljs.core.str.cljs$core$IFn$_invoke$arity$1($description$$)].join(""), cljs$cst$2615$content_type, $content_type$$], null));
};
...
ajax.easy.keyword_response_format_element = function($G__46353$jscomp$inline_5070_format$$, $JSCompiler_inline_result$jscomp$920_format_params$$) {
  if ($APP.cljs.core.vector_QMARK_($G__46353$jscomp$inline_5070_format$$)) {
    var $JSCompiler_temp_const$$ = $APP.cljs.core.PersistentVector, $JSCompiler_temp_const$jscomp$0$$ = $APP.cljs.core.PersistentVector.EMPTY_NODE, $JSCompiler_temp_const$jscomp$1$$ = $APP.cljs.core.first($G__46353$jscomp$inline_5070_format$$);
    $G__46353$jscomp$inline_5070_format$$ = $APP.cljs.core.second($G__46353$jscomp$inline_5070_format$$);
    $JSCompiler_inline_result$jscomp$920_format_params$$ = ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2($G__46353$jscomp$inline_5070_format$$, $JSCompiler_inline_result$jscomp$920_format_params$$) : ajax.easy.keyword_response_format_element.call(null, $G__46353$jscomp$inline_5070_format$$, $JSCompiler_inline_result$jscomp$920_format_params$$);
  ...
  if ($APP.cljs.core.map_QMARK_($G__46353$jscomp$inline_5070_format$$)) {
    return $G__46353$jscomp$inline_5070_format$$;
  }
  if ($APP.cljs.core.fn_QMARK_($G__46353$jscomp$inline_5070_format$$)) {
    return new $APP.cljs.core.PersistentArrayMap(null, 2, [cljs$cst$2624$read, $G__46353$jscomp$inline_5070_format$$, cljs$cst$2620$description, "custom"], null);
  }
  if ($G__46353$jscomp$inline_5070_format$$ == null) {
    return ajax.easy.detect_response_format.cljs$core$IFn$_invoke$arity$0();
  }
  switch($G__46353$jscomp$inline_5070_format$$ instanceof $APP.cljs.core.Keyword ? $G__46353$jscomp$inline_5070_format$$.fqn : null) {
    case "transit":
...
ajax.easy.keyword_response_format = function($format$$, $format_params$$) {
  return $APP.cljs.core.vector_QMARK_($format$$) ? $APP.cljs.core.apply.cljs$core$IFn$_invoke$arity$2($APP.cljs.core.vector, $APP.cljs.core.map.cljs$core$IFn$_invoke$arity$2(function($p1__46356_SHARP_$$) {
    return ajax.easy.keyword_response_format_element($p1__46356_SHARP_$$, $format_params$$);
...
ajax.easy.transform_handler = function($map__46371__$1_p__46370$$) {
  $map__46371__$1_p__46370$$ = $APP.cljs.core.__destructure_map($map__46371__$1_p__46370$$);
  var $handler$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46371__$1_p__46370$$, $APP.cljs$cst$1736$handler), $error_handler$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46371__$1_p__46370$$, cljs$cst$2642$error_handler), $finally$$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46371__$1_p__46370$$, $APP.cljs$cst$2643$finally), $h$$ = $APP.cljs.core.truth_($handler$$) ? $handler$$ : $APP.cljs.core.deref(ajax.easy.default_handler), $e$$ = $APP.cljs.core.truth_($error_handler$$) ? 
  $error_handler$$ : $APP.cljs.core.deref(ajax.easy.default_error_handler);
  return function($p__46375_result$$) {
    var $fexpr__46382_46403_ok$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($p__46375_result$$, 0, null);
    $p__46375_result$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($p__46375_result$$, 1, null);
    $fexpr__46382_46403_ok$$ = $APP.cljs.core.truth_($fexpr__46382_46403_ok$$) ? $h$$ : $e$$;
    $fexpr__46382_46403_ok$$.cljs$core$IFn$_invoke$arity$1 ? $fexpr__46382_46403_ok$$.cljs$core$IFn$_invoke$arity$1($p__46375_result$$) : $fexpr__46382_46403_ok$$.call(null, $p__46375_result$$);
...
ajax.easy.transform_opts = function($map__46390__$1_p__46389$$) {
  $map__46390__$1_p__46389$$ = $APP.cljs.core.__destructure_map($map__46390__$1_p__46389$$);
  var $JSCompiler_temp_const$jscomp$922_method$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46390__$1_p__46389$$, $APP.cljs$cst$2631$method), $format$jscomp$33_rf$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46390__$1_p__46389$$, cljs$cst$2632$format), $response_format$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46390__$1_p__46389$$, cljs$cst$2634$response_format);
  $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46390__$1_p__46389$$, $APP.cljs$cst$410$params);
  var $JSCompiler_inline_result$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46390__$1_p__46389$$, $APP.cljs$cst$411$body) == null && $APP.cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2($JSCompiler_temp_const$jscomp$922_method$$, "GET");
  ...
  $format$jscomp$33_rf$$ = $JSCompiler_temp_const$$.call($JSCompiler_temp_const$jscomp$922_method$$, $JSCompiler_inline_result$$) ? ajax.easy.keyword_request_format($format$jscomp$33_rf$$, $map__46390__$1_p__46389$$) : null;
  return $APP.cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic($map__46390__$1_p__46389$$, $APP.cljs$cst$1736$handler, ajax.easy.transform_handler($map__46390__$1_p__46389$$), $APP.cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs$cst$2632$format, $format$jscomp$33_rf$$, cljs$cst$2634$response_format, ajax.easy.keyword_response_format($response_format$$, $map__46390__$1_p__46389$$)], 0));
};
...
$APP.goog.net.XhrIo.prototype.ajax$protocols$AjaxImpl$_js_ajax_request$arity$3 = function($this$$jscomp$758_uri$$, $method$$, $handler$$) {
  ...
  $APP.goog.events.listen(this, $APP.goog.net.EventType.COMPLETE, function($G__46349_p1__46344_SHARP_$$) {
    $G__46349_p1__46344_SHARP_$$ = $G__46349_p1__46344_SHARP_$$.target;
    return $handler$$.cljs$core$IFn$_invoke$arity$1 ? $handler$$.cljs$core$IFn$_invoke$arity$1($G__46349_p1__46344_SHARP_$$) : $handler$$.call(null, $G__46349_p1__46344_SHARP_$$);
  });
...
$APP.goog.net.XhrManager.prototype.ajax$protocols$AjaxImpl$_js_ajax_request$arity$3 = function($this$$jscomp$766_uri$$, $method$$, $handler$$) {
  var $map__46360__$1_max_retries$$ = $APP.cljs.core.__destructure_map($method$$);
  $this$$jscomp$766_uri$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, $APP.cljs$cst$2493$uri);
  $method$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, $APP.cljs$cst$2631$method);
  var $body$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, $APP.cljs$cst$411$body), $headers$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, $APP.cljs$cst$2606$headers), $id$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, $APP.cljs$cst$396$id), $timeout$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$3($map__46360__$1_max_retries$$, $APP.cljs$cst$2627$timeout, 0), $priority$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, 
  cljs$cst$2646$priority);
  $map__46360__$1_max_retries$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46360__$1_max_retries$$, cljs$cst$2647$max_retries);
  this.setTimeoutInterval($timeout$$);
  this.send($id$$, $this$$jscomp$766_uri$$, $method$$, $body$$, $APP.cljs.core.clj__GT_js($headers$$), $priority$$, $handler$$, $map__46360__$1_max_retries$$);
  return this;
};
ajax.xml_http_request = {};
ajax.xml_http_request.ready_state = function($G__46352_e$$) {
  $G__46352_e$$ = $G__46352_e$$.target.readyState;
  var $fexpr__46351$$ = new $APP.cljs.core.PersistentArrayMap(null, 5, [0, cljs$cst$2648$not_initialized, 1, cljs$cst$2649$connection_established, 2, cljs$cst$2650$request_received, 3, cljs$cst$2651$processing_request, 4, cljs$cst$2652$response_ready], null);
  return $fexpr__46351$$.cljs$core$IFn$_invoke$arity$1 ? $fexpr__46351$$.cljs$core$IFn$_invoke$arity$1($G__46352_e$$) : $fexpr__46351$$.call(null, $G__46352_e$$);
};
...
ajax.xml_http_request.xmlhttprequest.prototype.ajax$protocols$AjaxImpl$_js_ajax_request$arity$3 = function($body$jscomp$51_this$$$, $G__46411_headers$$, $handler$$) {
  var $map__46361__$1_response_format$$ = $APP.cljs.core.__destructure_map($G__46411_headers$$), $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46361__$1_response_format$$, $APP.cljs$cst$2493$uri), $G__46413_c__5548__auto___46410_count__46368_46398_method$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46361__$1_response_format$$, $APP.cljs$cst$2631$method);
  $body$jscomp$51_this$$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46361__$1_response_format$$, $APP.cljs$cst$411$body);
  $G__46411_headers$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46361__$1_response_format$$, $APP.cljs$cst$2606$headers);
  var $i__46369_46399_timeout$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$3($map__46361__$1_response_format$$, $APP.cljs$cst$2627$timeout, 0), $k_46401_with_credentials$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$3($map__46361__$1_response_format$$, cljs$cst$2644$with_credentials, !1);
  $map__46361__$1_response_format$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__46361__$1_response_format$$, cljs$cst$2634$response_format);
  var $this$__$1$$ = this;
  $this$__$1$$.withCredentials = $k_46401_with_credentials$$;
  $this$__$1$$.onreadystatechange = function($p1__46357_SHARP_$$) {
    return $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs$cst$2652$response_ready, ajax.xml_http_request.ready_state($p1__46357_SHARP_$$)) ? $handler$$.cljs$core$IFn$_invoke$arity$1 ? $handler$$.cljs$core$IFn$_invoke$arity$1($this$__$1$$) : $handler$$.call(null, $this$__$1$$) : null;
  };
  $this$__$1$$.open($G__46413_c__5548__auto___46410_count__46368_46398_method$$, $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$, !0);
  $this$__$1$$.timeout = $i__46369_46399_timeout$$;
  $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$ = $APP.cljs$cst$139$type.cljs$core$IFn$_invoke$arity$1($map__46361__$1_response_format$$);
  $APP.cljs.core.truth_($G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$) && ($this$__$1$$.responseType = $APP.cljs.core.name($G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$));
  $G__46411_headers$$ = $APP.cljs.core.seq($G__46411_headers$$);
  $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$ = null;
  for ($i__46369_46399_timeout$$ = $G__46413_c__5548__auto___46410_count__46368_46398_method$$ = 0;;) {
    if ($i__46369_46399_timeout$$ < $G__46413_c__5548__auto___46410_count__46368_46398_method$$) {
      $map__46361__$1_response_format$$ = $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$.cljs$core$IIndexed$_nth$arity$2(null, $i__46369_46399_timeout$$), $k_46401_with_credentials$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($map__46361__$1_response_format$$, 0, null), $map__46361__$1_response_format$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($map__46361__$1_response_format$$, 1, null), $this$__$1$$.setRequestHeader($k_46401_with_credentials$$, $map__46361__$1_response_format$$), 
      $i__46369_46399_timeout$$ += 1;
    } else {
      if ($G__46411_headers$$ = $APP.cljs.core.seq($G__46411_headers$$)) {
        $APP.cljs.core.chunked_seq_QMARK_($G__46411_headers$$) ? ($G__46413_c__5548__auto___46410_count__46368_46398_method$$ = $APP.cljs.core.chunk_first($G__46411_headers$$), $G__46411_headers$$ = $APP.cljs.core.chunk_rest($G__46411_headers$$), $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$ = $G__46413_c__5548__auto___46410_count__46368_46398_method$$, $G__46413_c__5548__auto___46410_count__46368_46398_method$$ = $APP.cljs.core.count($G__46413_c__5548__auto___46410_count__46368_46398_method$$)) : 
        ($G__46413_c__5548__auto___46410_count__46368_46398_method$$ = $APP.cljs.core.first($G__46411_headers$$), $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($G__46413_c__5548__auto___46410_count__46368_46398_method$$, 0, null), $G__46413_c__5548__auto___46410_count__46368_46398_method$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($G__46413_c__5548__auto___46410_count__46368_46398_method$$, 1, null), $this$__$1$$.setRequestHeader($G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$, 
        $G__46413_c__5548__auto___46410_count__46368_46398_method$$), $G__46411_headers$$ = $APP.cljs.core.next($G__46411_headers$$), $G__46412_chunk__46367_46397_k_46416_temp__5825__auto___46394_uri$$ = null, $G__46413_c__5548__auto___46410_count__46368_46398_method$$ = 0), $i__46369_46399_timeout$$ = 0;
      } else {
        break;
      }
    }
...
ajax.core.GET = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$210_argseq__5756__auto__$$ = [], $len__5749__auto___46440$$ = arguments.length, $i__5750__auto___46441$$ = 0;;) {
    if ($i__5750__auto___46441$$ < $len__5749__auto___46440$$) {
      $args__5755__auto__$jscomp$210_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46441$$]), $i__5750__auto___46441$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.HEAD = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$211_argseq__5756__auto__$$ = [], $len__5749__auto___46443$$ = arguments.length, $i__5750__auto___46444$$ = 0;;) {
    if ($i__5750__auto___46444$$ < $len__5749__auto___46443$$) {
      $args__5755__auto__$jscomp$211_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46444$$]), $i__5750__auto___46444$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.HEAD.cljs$lang$applyTo = function($seq46424_seq46424__$1$$) {
  var $G__46425$$ = $APP.cljs.core.first($seq46424_seq46424__$1$$);
  $seq46424_seq46424__$1$$ = $APP.cljs.core.next($seq46424_seq46424__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46425$$, $seq46424_seq46424__$1$$);
};
ajax.core.POST = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$212_argseq__5756__auto__$$ = [], $len__5749__auto___46446$$ = arguments.length, $i__5750__auto___46447$$ = 0;;) {
    if ($i__5750__auto___46447$$ < $len__5749__auto___46446$$) {
      $args__5755__auto__$jscomp$212_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46447$$]), $i__5750__auto___46447$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.POST.cljs$lang$applyTo = function($seq46426_seq46426__$1$$) {
  var $G__46427$$ = $APP.cljs.core.first($seq46426_seq46426__$1$$);
  $seq46426_seq46426__$1$$ = $APP.cljs.core.next($seq46426_seq46426__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46427$$, $seq46426_seq46426__$1$$);
};
ajax.core.PUT = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$213_argseq__5756__auto__$$ = [], $len__5749__auto___46449$$ = arguments.length, $i__5750__auto___46450$$ = 0;;) {
    if ($i__5750__auto___46450$$ < $len__5749__auto___46449$$) {
      $args__5755__auto__$jscomp$213_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46450$$]), $i__5750__auto___46450$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.PUT.cljs$lang$applyTo = function($seq46428_seq46428__$1$$) {
  var $G__46429$$ = $APP.cljs.core.first($seq46428_seq46428__$1$$);
  $seq46428_seq46428__$1$$ = $APP.cljs.core.next($seq46428_seq46428__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46429$$, $seq46428_seq46428__$1$$);
};
ajax.core.DELETE = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$214_argseq__5756__auto__$$ = [], $len__5749__auto___46456$$ = arguments.length, $i__5750__auto___46457$$ = 0;;) {
    if ($i__5750__auto___46457$$ < $len__5749__auto___46456$$) {
      $args__5755__auto__$jscomp$214_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46457$$]), $i__5750__auto___46457$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.DELETE.cljs$lang$applyTo = function($seq46430_seq46430__$1$$) {
  var $G__46431$$ = $APP.cljs.core.first($seq46430_seq46430__$1$$);
  $seq46430_seq46430__$1$$ = $APP.cljs.core.next($seq46430_seq46430__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46431$$, $seq46430_seq46430__$1$$);
};
ajax.core.OPTIONS = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$215_argseq__5756__auto__$$ = [], $len__5749__auto___46459$$ = arguments.length, $i__5750__auto___46460$$ = 0;;) {
    if ($i__5750__auto___46460$$ < $len__5749__auto___46459$$) {
      $args__5755__auto__$jscomp$215_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46460$$]), $i__5750__auto___46460$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.OPTIONS.cljs$lang$applyTo = function($seq46432_seq46432__$1$$) {
  var $G__46433$$ = $APP.cljs.core.first($seq46432_seq46432__$1$$);
  $seq46432_seq46432__$1$$ = $APP.cljs.core.next($seq46432_seq46432__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46433$$, $seq46432_seq46432__$1$$);
};
ajax.core.TRACE = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$216_argseq__5756__auto__$$ = [], $len__5749__auto___46462$$ = arguments.length, $i__5750__auto___46463$$ = 0;;) {
    if ($i__5750__auto___46463$$ < $len__5749__auto___46462$$) {
      $args__5755__auto__$jscomp$216_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46463$$]), $i__5750__auto___46463$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.TRACE.cljs$lang$applyTo = function($seq46434_seq46434__$1$$) {
  var $G__46435$$ = $APP.cljs.core.first($seq46434_seq46434__$1$$);
  $seq46434_seq46434__$1$$ = $APP.cljs.core.next($seq46434_seq46434__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46435$$, $seq46434_seq46434__$1$$);
};
ajax.core.PATCH = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$217_argseq__5756__auto__$$ = [], $len__5749__auto___46465$$ = arguments.length, $i__5750__auto___46466$$ = 0;;) {
    if ($i__5750__auto___46466$$ < $len__5749__auto___46465$$) {
      $args__5755__auto__$jscomp$217_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46466$$]), $i__5750__auto___46466$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.PATCH.cljs$lang$applyTo = function($seq46436_seq46436__$1$$) {
  var $G__46437$$ = $APP.cljs.core.first($seq46436_seq46436__$1$$);
  $seq46436_seq46436__$1$$ = $APP.cljs.core.next($seq46436_seq46436__$1$$);
  return this.cljs$core$IFn$_invoke$arity$variadic($G__46437$$, $seq46436_seq46436__$1$$);
};
ajax.core.PURGE = function($var_args$$) {
  for (var $args__5755__auto__$jscomp$218_argseq__5756__auto__$$ = [], $len__5749__auto___46468$$ = arguments.length, $i__5750__auto___46469$$ = 0;;) {
    if ($i__5750__auto___46469$$ < $len__5749__auto___46468$$) {
      $args__5755__auto__$jscomp$218_argseq__5756__auto__$$.push(arguments[$i__5750__auto___46469$$]), $i__5750__auto___46469$$ += 1;
    } else {
      break;
    }
  }
...
ajax.core.PURGE.cljs$lang$applyTo = function($seq46438_seq46438__$1$$) {
