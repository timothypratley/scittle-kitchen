(function(){
'use strict';
var cljs$cst$5439$completions = new $APP.cljs.core.Keyword(null, "completions", "completions", -190930179), cljs$cst$5441$sci_DOT_nrepl_DOT_info_SLASH_success = new $APP.cljs.core.Keyword("sci.nrepl.info", "success", "sci.nrepl.info/success", -493835426), cljs$cst$5450$load_file = new $APP.cljs.core.Keyword(null, "load-file", "load-file", -424586670), cljs$cst$5437$unqualified = new $APP.cljs.core.Keyword(null, "unqualified", "unqualified", -98904653), cljs$cst$5451$clone = new $APP.cljs.core.Keyword(null, 
"clone", "clone", 711747572), cljs$cst$5454$complete = new $APP.cljs.core.Keyword(null, "complete", "complete", -500388775), cljs$cst$5452$lookup = new $APP.cljs.core.Keyword(null, "lookup", "lookup", 1225356838), cljs$cst$5444$arglists_str = new $APP.cljs.core.Keyword(null, "arglists-str", "arglists-str", 1439431437), cljs$cst$5453$describe = new $APP.cljs.core.Keyword(null, "describe", "describe", 1369790582), cljs$cst$5449$ops = new $APP.cljs.core.Keyword(null, "ops", "ops", 1237330063), cljs$cst$5447$sci_DOT_nrepl_DOT_server_SLASH_error = 
new $APP.cljs.core.Keyword("sci.nrepl.server", "error", "sci.nrepl.server/error", 855827645), cljs$cst$5436$resolved__76210__auto__ = new $APP.cljs.core.Symbol(null, "resolved__76210__auto__", "resolved__76210__auto__", 1535766010, null), cljs$cst$5448$versions = new $APP.cljs.core.Keyword(null, "versions", "versions", 536521978), cljs$cst$5438$qualified = new $APP.cljs.core.Keyword(null, "qualified", "qualified", -2065109343), cljs$cst$5446$sci_DOT_nrepl_DOT_server_SLASH_success = new $APP.cljs.core.Keyword("sci.nrepl.server", 
"success", "sci.nrepl.server/success", -67357591), cljs$cst$5443$eldoc = new $APP.cljs.core.Keyword(null, "eldoc", "eldoc", -1321421900), cljs$cst$5445$send_fn = new $APP.cljs.core.Keyword(null, "send-fn", "send-fn", 351002041), cljs$cst$5442$sci_DOT_nrepl_DOT_info_SLASH_error = new $APP.cljs.core.Keyword("sci.nrepl.info", "error", "sci.nrepl.info/error", 1267042764);
$APP.sci.nrepl = {};
...
$APP.sci.nrepl.completions.ns_imports__GT_completions = function($ctx$jscomp$275_props$jscomp$6_temp__5825__auto__$$, $query_ns$$, $query$$) {
  ...
  null, 1, null), new $APP.cljs.core.List(null, $APP.cljs.core.vec($APP.cljs.core.sequence.cljs$core$IFn$_invoke$arity$1($APP.cljs.core.seq($APP.cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new $APP.cljs.core.List(null, cljs$cst$5436$resolved__76210__auto__, null, 1, null), new $APP.cljs.core.List(null, $APP.cljs.core.sequence.cljs$core$IFn$_invoke$arity$1($APP.cljs.core.seq($APP.cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new $APP.cljs.core.List(null, $APP.cljs$cst$1280$cljs_DOT_core_SLASH_resolve, 
  ...
  if ($APP.cljs.core.truth_($resolved$$) && ($ctx$jscomp$275_props$jscomp$6_temp__5825__auto__$$ = $APP.cljs.core.truth_($name_part$$) ? function() {
    ...
    $ctx$jscomp$275_props$jscomp$6_temp__5825__auto__$$ = function() {
      for (var $obj$$ = $imported$$, $G__76241_props$$ = $APP.cljs.core.PersistentVector.EMPTY;;) {
        if ($APP.cljs.core.truth_($obj$$)) {
          var $G__76240$$ = Object.getPrototypeOf($obj$$);
          $G__76241_props$$ = $APP.cljs.core.into.cljs$core$IFn$_invoke$arity$2($G__76241_props$$, Object.getOwnPropertyNames($obj$$));
          $obj$$ = $G__76240$$;
        } else {
          return $G__76241_props$$;
        }
      }
    }();
...
$APP.sci.nrepl.completions.completions = function($ns_str$$) {
  var $map__76232__$1$$ = $APP.cljs.core.__destructure_map($ns_str$$);
  $ns_str$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__76232__$1$$, $APP.cljs$cst$176$ns);
  var $ctx$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($map__76232__$1$$, $APP.cljs$cst$588$ctx);
  try {
    ...
    try {
      var $temp__5823__auto__$$ = function() {
        var $or__5025__auto__$$ = $APP.cljs$cst$219$symbol.cljs$core$IFn$_invoke$arity$1($map__76232__$1$$);
        return $APP.cljs.core.truth_($or__5025__auto__$$) ? $or__5025__auto__$$ : $APP.cljs$cst$1543$prefix.cljs$core$IFn$_invoke$arity$1($map__76232__$1$$);
      }();
      if ($APP.cljs.core.truth_($temp__5823__auto__$$)) {
        var $has_namespace_QMARK_$$ = $APP.clojure.string.includes_QMARK_($temp__5823__auto__$$, "/"), $query_ns$$ = $has_namespace_QMARK_$$ ? function() {
          var $G__76234_G__76234__$1$$ = $APP.clojure.string.split.cljs$core$IFn$_invoke$arity$2($temp__5823__auto__$$, /\//);
          $G__76234_G__76234__$1$$ = $G__76234_G__76234__$1$$ == null ? null : $APP.cljs.core.first($G__76234_G__76234__$1$$);
          return $G__76234_G__76234__$1$$ == null ? null : $APP.cljs.core.symbol.cljs$core$IFn$_invoke$arity$1($G__76234_G__76234__$1$$);
        ...
        }, $svs$$), $completions__$1$$ = $APP.cljs.core.concat.cljs$core$IFn$_invoke$arity$2($completions$$, $from_imports$$), $completions__$2$$ = $APP.cljs.core.vec($APP.cljs.core.distinct.cljs$core$IFn$_invoke$arity$1($APP.cljs.core.map.cljs$core$IFn$_invoke$arity$2(function($G__76239_name$$) {
          var $namespace$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($G__76239_name$$, 0, null);
          $G__76239_name$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($G__76239_name$$, 1, null);
          $G__76239_name$$ = new $APP.cljs.core.PersistentArrayMap(null, 1, ["candidate", $APP.cljs.core.str.cljs$core$IFn$_invoke$arity$1($G__76239_name$$)], null);
          return $APP.cljs.core.truth_($namespace$$) ? $APP.cljs.core.assoc.cljs$core$IFn$_invoke$arity$3($G__76239_name$$, "ns", $APP.cljs.core.str.cljs$core$IFn$_invoke$arity$1($namespace$$)) : $G__76239_name$$;
        }, $completions__$1$$)));
    ...
    return console.error("ERROR", $e76233$$), new $APP.cljs.core.PersistentArrayMap(null, 2, [cljs$cst$5439$completions, $APP.cljs.core.PersistentVector.EMPTY, $APP.cljs$cst$109$status, new $APP.cljs.core.PersistentVector(null, 1, 5, $APP.cljs.core.PersistentVector.EMPTY_NODE, ["done"], null)], null);
  }
};
$APP.sci.nrepl.info = {};
...
$APP.sci.nrepl.info.info = function($G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$) {
  var $ctx$jscomp$277_doc$$ = $APP.cljs.core.__destructure_map($G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$);
  $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($ctx$jscomp$277_doc$$, $APP.cljs$cst$176$ns);
  var $G__76229_G__76229__$1_kind$jscomp$26_sym$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($ctx$jscomp$277_doc$$, $APP.cljs$cst$242$sym);
  $ctx$jscomp$277_doc$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($ctx$jscomp$277_doc$$, $APP.cljs$cst$588$ctx);
  if ($APP.cljs.core.not($G__76229_G__76229__$1_kind$jscomp$26_sym$$)) {
  ...
  $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$ = $APP.sci.nrepl.info.format_1($APP.sci.nrepl.info.format_1("(when-let [the-var (ns-resolve '%s '%s)]\n               (meta the-var))", $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$), $G__76229_G__76229__$1_kind$jscomp$26_sym$$);
  try {
    var $line$$ = new $APP.cljs.core.PersistentVector(null, 2, 5, $APP.cljs.core.PersistentVector.EMPTY_NODE, [cljs$cst$5441$sci_DOT_nrepl_DOT_info_SLASH_success, $APP.sci.core.eval_string_STAR_($ctx$jscomp$277_doc$$, $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$)], null);
  } catch ($e76228$$) {
    $line$$ = new $APP.cljs.core.PersistentVector(null, 2, 5, $APP.cljs.core.PersistentVector.EMPTY_NODE, [cljs$cst$5442$sci_DOT_nrepl_DOT_info_SLASH_error, $APP.cljs.core.str.cljs$core$IFn$_invoke$arity$1($e76228$$)], null);
  }
  $G__76229_G__76229__$1_kind$jscomp$26_sym$$ = $APP.cljs.core.nth.cljs$core$IFn$_invoke$arity$3($line$$, 0, null);
  ...
  $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$ = $APP.cljs.core.get.cljs$core$IFn$_invoke$arity$2($arglists$$, $APP.cljs$cst$208$file);
  ...
  return $APP.cljs.core.truth_($APP.cljs.core.truth_($name$$) ? $APP.cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2($G__76229_G__76229__$1_kind$jscomp$26_sym$$, cljs$cst$5441$sci_DOT_nrepl_DOT_info_SLASH_success) : $name$$) ? ($G__76229_G__76229__$1_kind$jscomp$26_sym$$ = new $APP.cljs.core.PersistentArrayMap(null, 6, [$APP.cljs$cst$176$ns, function() {
    var $G__76230__$1$$ = $val$$ == null ? null : $APP.cljs$cst$176$ns.cljs$core$IFn$_invoke$arity$1($val$$);
    return $G__76230__$1$$ == null ? null : $APP.cljs.core.ns_name($G__76230__$1$$);
  }(), $APP.cljs$cst$273$arglists, $APP.cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic($APP.cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([$arglists$$], 0)), cljs$cst$5443$eldoc, $APP.cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(function($p1__76217_SHARP_$$) {
    return $APP.cljs.core.mapv.cljs$core$IFn$_invoke$arity$2($APP.cljs.core.str, $p1__76217_SHARP_$$);
  }, $arglists$$), cljs$cst$5444$arglists_str, $APP.cljs.core.apply.cljs$core$IFn$_invoke$arity$2($APP.cljs.core.array, $arglists$$).join("\n"), $APP.cljs$cst$109$status, new $APP.cljs.core.PersistentVector(null, 1, 5, $APP.cljs.core.PersistentVector.EMPTY_NODE, ["done"], null), $APP.cljs$cst$272$name, $name$$], null), $G__76229_G__76229__$1_kind$jscomp$26_sym$$ = $APP.cljs.core.truth_($ctx$jscomp$277_doc$$) ? $APP.cljs.core.assoc.cljs$core$IFn$_invoke$arity$3($G__76229_G__76229__$1_kind$jscomp$26_sym$$, 
  $APP.cljs$cst$256$doc, $ctx$jscomp$277_doc$$) : $G__76229_G__76229__$1_kind$jscomp$26_sym$$, $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$ = $APP.cljs.core.truth_($G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$) ? $APP.cljs.core.assoc.cljs$core$IFn$_invoke$arity$3($G__76229_G__76229__$1_kind$jscomp$26_sym$$, $APP.cljs$cst$208$file, $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$) : $G__76229_G__76229__$1_kind$jscomp$26_sym$$, $APP.cljs.core.truth_($line$$) ? $APP.cljs.core.assoc.cljs$core$IFn$_invoke$arity$3($G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$, 
  $APP.cljs$cst$209$line, $line$$) : $G__76229__$2_code$jscomp$19_file$jscomp$12_ns_str$$) : new $APP.cljs.core.PersistentArrayMap(null, 1, [$APP.cljs$cst$109$status, new $APP.cljs.core.PersistentVector(null, 2, 5, $APP.cljs.core.PersistentVector.EMPTY_NODE, ["done", "no-eldoc"], null)], null);
};
...
var temp__5825__auto___76296 = window.SCITTLE_NREPL_WEBSOCKET_PORT;
if ($APP.cljs.core.truth_(temp__5825__auto___76296)) {
  var ws_port_76297 = temp__5825__auto___76296;
  window.ws_nrepl = new WebSocket($APP.scittle.nrepl.ws_url(window.location.hostname, ws_port_76297, "_nrepl"));
}
var temp__5825__auto___76298 = $APP.sci.nrepl.server.nrepl_websocket();
if ($APP.cljs.core.truth_(temp__5825__auto___76298)) {
  var ws_76299 = temp__5825__auto___76298;
  ws_76299.onmessage = function($event$$) {
    return $APP.sci.nrepl.server.handle_nrepl_message($APP.clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1($event$$.data));
  };
  ws_76299.onerror = function($event$$) {
